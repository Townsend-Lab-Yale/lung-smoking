...
test_df = df.sort_values(by = ['SAMPLE_TYPE','LINES_OF_TX_PRIOR_IMPACT','TUMOR_PURITY'], ascending=[False, True, False])
test_df = test_df[['PATIENT_ID','SAMPLE_ID','SAMPLE_TYPE','METASTATIC_SITE','PRIMARY_SITE','SO_COMMENTS','SAMPLE_COVERAGE','TUMOR_PURITY','SOMATIC_STATUS','GENE_PANEL','LINES_OF_TX_PRIOR_IMPACT','DRIVER_MUTATIONS','SAMPLE_PRE_LUNG_THERAPY']]
